...
const DropdownUser = () => {
  ...
  const handleUnlinkGoogle = async () => {
    ...
    const { value: password } = await Swal.fire({
        ...
        cancelButtonText: 'Cancelar',
        preConfirm: () => {
            const p1 = (document.getElementById('swal-pass1') as HTMLInputElement).value;
            const p2 = (document.getElementById('swal-pass2') as HTMLInputElement).value;
            if (!p1 || p1.length < 6) {
    ...
    try {
        ...
        Swal.fire({ title: 'Error', text: 'No se pudo desvincular la cuenta', icon: 'error', timer: 2000 });
    }
};
